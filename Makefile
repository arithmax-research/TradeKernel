...
# Link kernel
$(KERNEL_BIN): $(KERNEL_ENTRY_OBJ) $(KERNEL_OBJ) $(VGA_OBJ) $(MEMORY_OBJ) $(INTERRUPTS_OBJ) $(SHELL_OBJ) $(INTERRUPT_ASM_OBJ)
	$(LD) $(LDFLAGS) $(KERNEL_ENTRY_OBJ) $(KERNEL_OBJ) $(VGA_OBJ) $(MEMORY_OBJ) $(INTERRUPTS_OBJ) $(SHELL_OBJ) $(INTERRUPT_ASM_OBJ) -o $(KERNEL_BIN)
