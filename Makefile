...
$(KERNEL_BIN): $(KERNEL_ENTRY_OBJ) $(KERNEL_OBJ) $(VGA_OBJ) $(MEMORY_OBJ) $(PAGING_OBJ) $(PAGING_ASM_OBJ) $(INTERRUPTS_OBJ) $(SHELL_OBJ) $(FS_OBJ) $(DISK_OBJ) $(INTERRUPT_ASM_OBJ) $(CONTEXT_SWITCH_OBJ) $(SYSCALL_ASM_OBJ) $(PROCESS_OBJ) $(SCHEDULER_OBJ) $(SYSCALLS_OBJ) $(IPC_OBJ) $(GUI_OBJ)
	$(LD) $(LDFLAGS) $(KERNEL_ENTRY_OBJ) $(KERNEL_OBJ) $(VGA_OBJ) $(MEMORY_OBJ) $(PAGING_OBJ) $(PAGING_ASM_OBJ) $(INTERRUPTS_OBJ) $(SHELL_OBJ) $(FS_OBJ) $(DISK_OBJ) $(INTERRUPT_ASM_OBJ) $(CONTEXT_SWITCH_OBJ) $(SYSCALL_ASM_OBJ) $(PROCESS_OBJ) $(SCHEDULER_OBJ) $(SYSCALLS_OBJ) $(IPC_OBJ) $(GUI_OBJ) -o $(KERNEL_BIN)
